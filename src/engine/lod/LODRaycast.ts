...
import {Camera, Intersection, Object3D, Raycaster, Vector2, Vector3, WebGLRenderer} from 'three';
import {MapView} from '../MapView';
import { MapNode } from '../Main';
...
export class LODRaycast implements LODControl 
{
	...
	public updateLOD(view: MapView, camera: Camera, _renderer: WebGLRenderer, _scene: Object3D): void
	{
		...
		{
			const node = intersects[i].object as MapNode;
