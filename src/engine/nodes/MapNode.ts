...
export abstract class MapNode extends Mesh 
{
	 ...
	 */
	public parentNode: MapNode | null = null;
	 ...
	 */
	public childrenCache: Object3D[] | null = null;
	 ...
	 */
	public static baseGeometry: BufferGeometry | null = null;

	/**
	 * Base scale applied to the map viewer object.
	 */
	public static baseScale: Vector3 | null = null;
	...
	public constructor(parentNode: MapNode | null = null, mapView: MapView | null = null, location: number = MapNode.root, level: number = 0, x: number = 0, y: number = 0, geometry?: BufferGeometry, material?: Material) 
	{
		super(geometry, material);
		// // console.log('Map Node level, x, y', level, x, y);
	...
	{
		// console.log('Load Texture Map Node');
		...
		catch (e) 
		{
			...
			console.log("map node catch part")
	 ...
	 *
	 * @param _direction - Direction to get neighbors.
	 * @returns The neighbors array, if no neighbors found returns empty.
	 */
	public getNeighborsDirection(_direction: number): MapNode[] 
	{
		// TODO <ADD CODE HERE>
