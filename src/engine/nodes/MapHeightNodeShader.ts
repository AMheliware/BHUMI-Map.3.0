...
{
	public constructor(parentNode: MapHeightNode | null = null, mapView: MapView | null = null, location: number = MapNode.root, level: number = 0, x: number = 0, y: number = 0) 
	{
	...
	{
		// // console.log('Load Texture Map Height Node Shader');
