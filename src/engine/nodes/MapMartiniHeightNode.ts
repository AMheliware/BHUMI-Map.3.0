...
export class MapMartiniHeightNode extends MapHeightNode
{
	...
	public constructor(parentNode: MapHeightNode | null = null, mapView: MapView | null = null, location: number = MapNode.root, level: number = 0, x: number = 0, y: number = 0, {elevationDecoder = null, meshMaxError = 10, exageration = 1} = {})
	{
	...
	public static prepareMaterial(material: Material, level: number, _exageration: number = 1.0): any 
	{
		material.userData = {
