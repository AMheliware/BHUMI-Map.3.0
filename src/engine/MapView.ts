...
import { MapBoxProvider } from './Main';

const DEV_MAPBOX_API_KEY = "pk.eyJ1IjoicmFqYW4wMjciLCJhIjoiY2s2b25oYTg1MDJtazNsbXZ4OTFqcnN2cSJ9.MGaLTVPvgOjQazj7ZTX1nQ";
...
export class MapView extends Mesh 
{
	 ...
	 */
	public lod: LODControl | null = null;

	/**
	 * Map tile color layer provider.
	 */
	public provider: MapProvider | null = null;

	public mapBoxProvider: MapBoxProvider | null = new MapBoxProvider(DEV_MAPBOX_API_KEY, "mapbox/satellite-streets-v10", MapBoxProvider.STYLE, "jpg70"); 

	/**
	 * Map height (terrain elevation) layer provider.
	 */
	public heightProvider: MapProvider | null = null;
	 ...
	 */
	public constructor(root: (number | MapNode) = MapView.PLANAR, provider: MapProvider = new OpenStreetMapsProvider(), heightProvider: MapProvider | null = null) 
	{
	 ...
	 */
	public onBeforeRender: (renderer: WebGLRenderer, scene: Scene, camera: Camera, geometry: BufferGeometry, material: Material, group: Group)=> void = (renderer, scene, camera, _geometry, _material, _group) => 
	{
	...
	public raycast(_raycaster: Raycaster, _intersects: any[]): boolean
	{
		return false;
	}
}
