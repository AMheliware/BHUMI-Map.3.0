...
export class CancelablePromise<T>
{
	 ...
	 * Finally callback
	 *
	 * @param _callback - Method to be called.
	 * @returns Promise for chainning.
	 */
	public finally(_callback: Function): CancelablePromise<T>
	{
	...
	{
		return new CancelablePromise(function executor(_resolve, reject) 
		{
			reject(reason);
		});
	}
	...
	public static all(promises: CancelablePromise<any>[]): CancelablePromise<any>
	{
		...
		function executor(resolve: (value: unknown) => void, reject: (reason?: unknown) => void): void 
		{
